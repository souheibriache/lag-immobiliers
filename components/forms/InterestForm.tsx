  ...
  switch (type) {
    case "property":
      return {
        ...
        defaultMessage:
          "Bonjour, je suis intéressé(e) par ce bien. Pourriez‑vous m'envoyer sa fiche détaillée ?",
        successMessage:
          "Merci de votre confiance. Un conseiller vous rappellera sous 24 h.",
    ...
    case "service":
      return {
        ...
        defaultMessage:
          "Bonjour, je souhaiterais en savoir plus sur vos services d'accompagnement.",
        successMessage:
  ...
  if (status === "success") {
    return (
      ...
      >
        ...
        <p className="text-gray-600 max-w-xs">{config.successMessage}</p>
      </motion.div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <div className="flex items-center gap-2 text-xs text-muted-foreground border border-dashed rounded-md p-2 bg-muted/50">
        ...
        Vos informations restent strictement confidentielles et ne seront jamais
