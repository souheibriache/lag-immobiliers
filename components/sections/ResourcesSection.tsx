      ...
      <div className="section-container">
        <header className="mb-16 text-center">
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Guides pratiques, livres blancs et outils maison pour passer au
            niveau supérieur.
          </p>
        ...
        <div className="flex flex-wrap justify-center gap-10 max-w-6xl mx-auto">
          {filteredProducts.slice(0, 6).map((product, index) => (
            <motion.article
              ...
              onClick={() =>
                (window.location.href = `/ressources/${product.id}`)
              }
            >
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-16">
            <p className="text-slate-600 dark:text-slate-400">
              Aucun {tab === "BOOK" ? "livre" : "produit"} disponible pour le
              moment.
            </p>
          </div>
        )}
