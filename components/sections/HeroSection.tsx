  ...
  return (
    <section className="relative isolate flex min-h-[100svh] items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          De la sélection du bien à la gestion locative complète, votre
          conseiller indépendant vous accompagne pour optimiser votre patrimoine
          immobilier.
        </motion.p>
